 ...
 * lcm_destroy() when no inter needed.
 */
LCM_API_FUNCTION
 ...
 *
 * The callback function for the subscription will no inter be
 * invoked when messages on the corresponding channel are received.  After this
 * function returns, @c handler is no inter valid and should not be used
 * anymore.
 *
